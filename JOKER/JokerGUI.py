...
model = load_model('../JOKER/chatbot_model.h5')
intents = json.loads(open('../JOKER/jokerintents.json').read())
words = pickle.load(open('../JOKER/words.pkl', 'rb'))
classes = pickle.load(open('../JOKER/classes.pkl', 'rb'))
